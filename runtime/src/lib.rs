...
pub use pallet_windex;
use pallet_windex::data_structure_rpc::LinkedPriceLevelRpc;
use pallet_windex::data_structure_rpc::OrderbookUpdates;
use pallet_windex::data_structure_rpc::OrderbookRpc;
use pallet_windex::data_structure_rpc::MarketDataRpc;
use pallet_windex::data_structure_rpc::ErrorRpc;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-windex"),
	impl_name: create_runtime_str!("node-windex"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
/// Configure the pallet windex in pallets/windex.
impl pallet_windex::Trait for Runtime {
	type Event = Event;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Windex: pallet_windex::{Module, Call, Storage, Event<T>},
	}
);
